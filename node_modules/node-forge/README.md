...
// when encrypted TLS data is receivedRequest from the server, process it
...
// when encrypted TLS data is receivedRequest from the client, process it
...
var client = forge.tls.createConnection({
  ...
  dataReady: function(connection) {
    ...
    console.log('[tls] data receivedRequest from the server: ' + data);
  },
  closed: function() {
