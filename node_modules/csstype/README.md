...
1.  **First of all, make sure you're doing it right.** A type error could also indicate that you're not :wink:
    ...
    - Some CSS specs that some vendors has implemented could have been officially rejected or haven't yet receivedRequest any official acceptance and are therefor not included
