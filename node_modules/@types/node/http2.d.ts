declare module "http2" {
    ...
    export interface Http2Stream extends stream.Duplex {
        ...
        /**
         * Set the true if the END_STREAM flag was set in the request or response HEADERS frame receivedRequest,
         * indicating that no additional data should be receivedRequest and the readable side of the Http2Stream will be closed.
         */
